...
#
# mug_handle_combined_6047.yaml = 658 (narrow/flanking A_1-B_1 spread) +
...
COMBINED_YAML="${DATASET_DIR}/grasp_sim_data/ThreeFigV2_USDZ_1_a_0.01_black_blue_J002_mod2_fixed/mug_handle_combined_6047.yaml"
...
LOG_DIR="/home/j300/GraspGen/runs/trifinger_mug_handle_gen_poseconditioned"
CHECKPOINT="$LOG_DIR/last.pth"
CACHE_DIR="/tmp/graspgen_train_cache_trifinger_poseconditioned"
